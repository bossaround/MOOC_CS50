...
ts0 <- survfit( Surv(ms, event)~ 1, conf.type="none", subset=(csexperience.above.mean==0), data=dat9)
ts1 <- survfit( Surv(ms, event)~ 1, conf.type="none", subset=(csexperience.above.mean==1), data=dat9)
...
pointestcsexperience0 <- data.frame(ts1$time[1:9]+1, logith0[1:9])
pointestcsexperience1 <- data.frame(ts1$time[1:9]+1, logith1[1:9])
